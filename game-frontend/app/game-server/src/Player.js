...
const BuildFieldCommand_1 = require("./Commands/BuildFieldCommand");
const PanelFieldSelected_1 = require("./Commands/PanelFieldSelected");
const PanelCharacterSelected_1 = require("./Commands/PanelCharacterSelected");
class Player {
